...
export default {
  ...
  reserve: {
    ...
    termsPrivacy: {
      text: 'Я прочитал и принял {{child}} и {{child_1}}.',
    },
    newsletterOptIn: 'Я хочу подписаться на вашу рассылку и получать информацию о новых продуктах и предложениях. Я могу отказаться от подписки в любой момент.',
    saveCustomerData: 'Сохранить ввод для следующего раза',
  },
  success: {
